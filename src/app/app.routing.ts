...
// import { ColonyHomeComponent } from './pages/_dapp/colony-home.component';
...
export const routes: Routes = [
    {
        ...
        component: PagesComponent, children: [
            { path: '', loadChildren: './_dapp/colony-home.module#ColonyHomeModule', data: { breadcrumb: 'FF dApp' } },
            //{ path: 'dashboard', loadChildren: './pages/dashboard/dashboard.module#DashboardModule', data: { breadcrumb: 'Dashboard' } },
            //{ path: 'colony', component: ColonyHomeComponent, data: { breadcrumb: 'Colony' } },
